	...
	<div class="joinWrap">
		<div class="join">
			...
			<div class="join_box">
				<form action="/shard/join" method="post" id="joinForm">
					<ul>
						...
						<li>
							...
							<input type="text" name="userId" id="userId" maxlength="12" value=""/>
						</li>
						
						<p class="msg_txt"><span class="userIdCheck"></span></p>
						<li>
							<label for="pwd">비밀번호</label> 
							<input type="password" name="pwd" id="pwd" />
						</li>
						<p class="msg_txt"><span style="font-size:13px; color:#0095ff" class="pwd_check1">영문 대소문자/숫자/특수문자를 혼용하여 2종류 10~16자 또는 3종류 10~16자 입력</span></p>
						<li>
							<label for="pwd_check">비밀번호 확인</label> 
							<input type="password" name="pwd_check" id="pwd_check" />
						</li>
						<p class="msg_txt"><span class="pwd_check2"></span></p>
						<li>
							<label for="email">이메일</label> 
							<input type="text" name="email" id="email" />
						</li>
						<p class="msg_txt"><span style="color:#949494">이메일은 회원제 서비스 이용, 본인확인 용도입니다. 마케팅 수신동의 시 해당 이메일을 이용합니다.</span></p>
						<p style="font-size:18px; font-weight:600; color:#000;">주소</p>
						<li class="address">
							<input type="text" id="postcode" placeholder="우편번호" name="postcode">
							<button type="button" onclick="execDaumPostcode()" class="adress_find">우편번호 찾기</button><br>
						...
						<li class="birth">
							<div class="birth_box"><label for="birthYear">생년</label><input type="text" name="birthYear" id="birthYear" maxlength="4"/></div>
							<div class="birth_box"><label for="birthMonth">월</label><input type="text" name="birthMonth" id="birthMonth" maxlength="2"/></div>
							<div class="birth_box"><label for="birthDay">일</label><input type="text" name="birthDay" id="birthDay" maxlength="2"/></div>
						</li>
						<li>
						...
						<li>
							<label for="phone_se">SMS 인증번호</label>
							<input type="text" name="phone_se" id="phone" maxlength="6" />
						</li>
					</ul>
				</form>
				<ul class="join_msg">
				...
				<div class="chkWrap">
					<div class="all_chk">
						<label for="all_check"><input type="checkbox" name="all_check" id="all_check" />  전체동의</label>
					</div>
					<div class="userInfo">
						<ul>
							<li>
								<label for="playmall"><input type="checkbox" name="playmall" id="playmall" /> 이용약관</label>
								<a href="#tit1">내용보기</a>
							</li>
							<li>
								<label for="userinfo"><input type="checkbox" name="userinfo" id="userinfo" /> 개인정보 수집 및 이용안내</label>
								<a href="#tit2">내용보기</a>
							</li>
						</ul>
					</div>
				...
				<div class="privercy-contract">
					<textarea rows="10" cols="80" wrap="off" readonly="readonly" style="height:194px; widht:650px;"><% 
